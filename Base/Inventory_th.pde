public class Inventory_th {

  private int inventoryspace = 64;
  private int nextitem = 0;
  private Item_th[] inventoryslot = new Item_th[inventoryspace];
  ...
  public int createItem(String name, int stackvalue, int startvalue, double weight, boolean duability, double usageprozentage) {
    ...
    inventoryslot[nextitem]= new Item_th(name, stackvalue, startvalue, weight, duability, usageprozentage);
    nextitem++;
    return 0;
  }
